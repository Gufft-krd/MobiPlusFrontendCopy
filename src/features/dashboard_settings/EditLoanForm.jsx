...
function EditLoanForm({ onCloseModal, debtor_id, debtor_location, debtor_website, debtor_email, debtor_phone_number, debtor_name }) {
    ...
    async function onFormSubmit(data) {
        ...
        editLoan({ newLoan, loanId: debtor_id });
        if (!isEditing) {
            onCloseModal();
        }
    }
                        ...
                        <FormRowVertical error={errors?.debtor_phone_number?.message}>
                            <div className="input ltr flex flex-row justify-between">
                                <input
                                    ...
                                    defaultValue={debtor_phone_number}
